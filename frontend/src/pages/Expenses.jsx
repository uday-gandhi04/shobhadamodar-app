...
const Expenses = () => {
      ...
      <IonPage>
        ...
        >
          <main className="mx-auto min-h-[100dvh] max-w-[480px] px-4 pb-8 pt-[max(1rem,env(safe-area-inset-top))]">
            ...
            <div className="mt-5 h-80 animate-pulse rounded-[20px] bg-white" />
  ...
  return (
    <IonPage>
      ...
      >
        <main className="mx-auto min-h-[100dvh] max-w-[480px] px-4 pb-10 pt-[max(0.9rem,env(safe-area-inset-top))]">
          {/* HEADER */}
          ...
          {/* SHIFT INFO */}
          <section className="mt-4 rounded-[18px] bg-white px-4 py-3 shadow-[0_4px_16px_rgba(15,23,42,0.05)]">
          ...
          <section className="mt-4 rounded-[20px] bg-white p-5 shadow-[0_4px_16px_rgba(15,23,42,0.04)]">
            ...
            <div className="mt-5">
              ...
              <div className="mt-2 flex h-[50px] items-center rounded-[12px] border border-slate-200 bg-slate-50 px-3 focus-within:border-[#047857] focus-within:bg-white">
                ...
                <input
                  ...
                  placeholder="500.00"
                  className="min-w-0 flex-1 bg-transparent text-[18px] font-bold text-slate-900 outline-none"
                />
              </div>
            </div>
            ...
            <div className="mt-4">
              ...
              <textarea
                ...
                placeholder="Tea and coffee for staff"
                rows={3}
                className="
                  mt-2
                  w-full
